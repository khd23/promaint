...
export class LocationService {
  ...
  private apiURL = environment.domain + "api/v1/locations";
  ...
  create(location:any): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL , JSON.stringify(location), this.httpOptions)
  ...
  update(id:number, location:any): Observable<any> {
    ...
    return this.httpClient.put(this.apiURL + '/' + id, JSON.stringify(location), this.httpOptions)
