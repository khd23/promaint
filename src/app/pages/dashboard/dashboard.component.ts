...
export class AppDashboardComponent {
  ...
  constructor() {
    ...
    this.profitExpanceChart = {
      series: [
        {
          ...
          data: [6000, 3000, 1000, 5000, 4000, 6000, 7000, 3000, 1000, 5000, 4000, 6000],
          color: '#fb977d',
        },
      ],
      ...
      xaxis: {
        type: 'category',
        categories: ['Janvier', 'Fevrier', 'Mars', 'April', 'Juin', 'Juillet', 'Aout', 'Septembre','Octobre','Novembre','Decembre'],
        axisTicks: {
          show: false,
        },
        axisBorder: {
